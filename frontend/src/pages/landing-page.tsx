                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-20 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center backdrop-blur-sm hover:bg-white/[0.08] transition-all">
                            ...
                            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">System Uptime</p>
                            <div className="text-5xl font-black text-white mb-3">99.9%</div>
                            <div className="flex items-center justify-center gap-1 text-emerald-400 font-bold text-sm">
                                <span className="material-symbols-outlined text-sm">trending_up</span>
                                <span>+0.01% this quarter</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center backdrop-blur-sm hover:bg-white/[0.08] transition-all">
                            ...
                            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Records Processed</p>
                            <div className="text-5xl font-black text-white mb-3">2.4M</div>
                            <div className="flex items-center justify-center gap-1 text-emerald-400 font-bold text-sm">
                                <span className="material-symbols-outlined text-sm">trending_up</span>
                                <span>+18% monthly growth</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center backdrop-blur-sm hover:bg-white/[0.08] transition-all">
                            ...
                            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Avg. Response</p>
                            <div className="text-5xl font-black text-white mb-3">&lt;120ms</div>
                            <div className="flex items-center justify-center gap-1 text-emerald-400 font-bold text-sm">
                                <span className="material-symbols-outlined text-sm">bolt</span>
                                <span>Sub-second across all APIs</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
                        ...
                        <div className="flex items-end gap-3 h-40">
                            {[
                                ...
                                { day: 'Tue', requests: 92, success: 99 },
                                { day: 'Wed', requests: 78, success: 97 },
                                { day: 'Thu', requests: 96, success: 99 },
                                { day: 'Fri', requests: 88, success: 98 },
                                { day: 'Sat', requests: 45, success: 100 },
                                { day: 'Sun', requests: 38, success: 100 },
                            ].map((d) => (
